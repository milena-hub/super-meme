...
public class Main {
	...
	public static void main(String[] args) {
		...
		p.dodaj(new LP(love_supreme, "Impulse! Records", 1500, 0, 40));
		p.dodaj(new LP(love_supreme, "Impulse! Records", 2500, 7, 120));
		p.dodaj(new LP(love_supreme, "Impulse! Records", 1250, 0, 30));
